  ...
  <d-navbar-nav class="border-left flex-row">
    <li class="nav-item border-right dropdown notifications">
      <a class="nav-link nav-link-icon text-center" v-d-toggle.notifications>
        <div class="nav-link-icon__wrapper">
          ...
          <d-badge pill theme="primary">2</d-badge>
        </div>
      </a>
      <d-collapse id="notifications" class="dropdown-menu dropdown-menu-small">
        ...
        <d-dropdown-item href="#">
          ...
          <div class="notification__content">
            ...
            <p>Last week your store’s sales count decreased by <span class="text-primary text-semibold">5.52%</span>. It could have been worse!</p>
          </div>
        </d-dropdown-item>
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle text-nowrap px-3" v-d-toggle.user-actions>
        <img class="user-avatar rounded-circle mr-2" src="@/assets/images/avatars/0.jpg" alt="User Avatar"> <span class="d-none d-md-inline-block">El Nico</span>
      </a>
      <d-collapse id="user-actions" class="dropdown-menu dropdown-menu-small">
        ...
        <d-dropdown-divider />
        <d-dropdown-item class="text-primary">
          <div @click="logout">
            <i class="material-icons text-primary">&#xE879;</i> Logout
          </div>
        </d-dropdown-item>
      </d-collapse>
    </li>
